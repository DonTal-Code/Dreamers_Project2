...
class ProductManager extends AbstractManager
{
    ...
    {
        return $this->pdo->query("SELECT product.name, category_id, product.id, category.name as category_name
        FROM " . self::TABLE . "
        JOIN category ON category.id = product.category_id WHERE category.id = product.category_id")->fetchAll();
    }

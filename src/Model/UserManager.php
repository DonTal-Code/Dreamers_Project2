...
class UserManager extends AbstractManager
{
    ...
    public function insert(array $user): int
    {
        ...
        (`username`, `firstname`, `lastname`, `email`, `password`, `birthday`, `adress`, `phone`, `is_admin`) 
        VALUES (:username, :firstname, :lastname, :email, :password, :birthday, :adress, :phone, :is_admin)");
